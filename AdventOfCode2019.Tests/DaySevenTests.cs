...
namespace AdventOfCode2019.Tests
{
    public class DaySevenTests
    {
        ...
        public void CalculateMaxSignalToThrusters(string input, int expected)
        {
            var sut = new DaySeven();
            var result = sut.CalculateMaxSignalToThrusters(input);
        ...
        public void FeedbackLoopCalculateMaxSignal(string input, int expected)
        {
            var sut = new DaySeven();
            var result = sut.FeedbackLoopCalculateMaxSignal(input);
